 ...
 */
@MappedSuperclass @EntityListeners(value = AnnotatedEntityListener.class)
public abstract class AbstractAnnotatedEntity<KEY> extends AbstractEntity<KEY>
     ...
     */
    @Column(nullable = false) private String creator;

    /**
     * Creation date.
     */
    @Column(nullable = false) @Temporal(TemporalType.TIMESTAMP) private Date creationDate;
     ...
     */
    @Column(nullable = false) private String lastModifier;
     ...
     */
    @Column(nullable = false) @Temporal(TemporalType.TIMESTAMP) private Date lastChangeDate;
    ...
    @Override public void setCreationDate(final Date creationDate) {
        this.creationDate = creationDate == null ? null : new Date(creationDate.getTime());
    }

    @Override public String getLastModifier() {
        return lastModifier;
    }

    @Override public void setLastModifier(final String lastModifier) {
        this.lastModifier = lastModifier;
    }

    @Override public Date getLastChangeDate() {
        return lastChangeDate == null ? creationDate : lastChangeDate;
    }

    @Override public void setLastChangeDate(final Date lastChangeDate) {
