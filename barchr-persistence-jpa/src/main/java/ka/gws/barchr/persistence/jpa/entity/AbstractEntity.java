...
public abstract class AbstractEntity<KEY> implements Entity<KEY> {
	...
	/**
	 * @param property
	 *            the integer representing a boolean value
	...
	/**
	 * @param value
	 *            the boolean value to be represented as integer
	...
	public String toString() {
		return new StringBuilder().append(getClass().getSimpleName()).append('[').append(getKey()).append(']')
				.toString();
	}
}
